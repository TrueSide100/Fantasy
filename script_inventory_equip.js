/* script_inventory_equip.js — Inventory and Equip Box: the stackable-items engine and
   ...
   This is two thirds of what used to be a single script_fieb.js (Finances/Inventory/
   Equip Box), itself one half of the original script_letter-of-records.js. Split again
   so this file can be read and edited independently of the currency-tracking half
   (script_finance.js: Finances). Depends on globals from index.html's inline Section 1
   (load that file first); load order relative to script_chatroom.js, script_finance.js,
   ...
   Contains sections 2 and 3 of the original script_fieb.js, in this order:
   ...
   Section 1 (FINANCES) — the currency-guard half of the original script_fieb.js — now
