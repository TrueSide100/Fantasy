/* script_saal.js — Skills & Abilities and Learning: the deterministic guards
   ...
   quick scanning (search for e.g. "3.4" to jump straight to a subsection):
     ...
     5. PRE-SEND CLAIM CHECK — ABILITY / SKILL — moved from script_letter_of_records.js.
          ...
          5.3  Roman-code claim resolution ("I use (i)")
               (ROMAN_CODE_RE, findSkillEntryByRomanCode)
          5.4  Layer 1 — deterministic regex check
               (checkAbilityClaim)
          5.5  Layer 2 — checker for the AI read step's extracted claims
...
// see findSkillEntryByRomanCode above for the parallel distinction on the roman-code path.
...
// ---------- 5.3 — Roman-code claim resolution: "(i)", "(iv)", etc. ----------
...
// ---------- 5.4 — Layer 1: deterministic regex claim check ----------
