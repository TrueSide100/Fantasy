...
const ABILITY_CONTEXT_RE = /\b(power|abilit|skill|techniqu|jutsu|spell|magic|affinit|innate|inborn|bloodline|born with|gift|talent|master|mastery|mastered|train|trained|learn|learned|studied|cultivat|system|status\s*window|interface|organ|mutat|curse|blessing|supernatural|superhuman|enchant|sorcery|wizard|elemental|psychic|telekin|energy|chakra|mana|\bki\b|aura|art\b|form\b|style\b)/i;
