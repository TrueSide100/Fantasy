...
// Fixed 4x4 grid position for each slot — the outer ring of a 4x4 grid (12 cells), with the
// center 2x2 block reserved for the hub icon. Row/col are 0-indexed.
const EQUIP_GRID_LAYOUT = {
  offhand:{row:0,col:0}, head:{row:0,col:1}, face:{row:0,col:2}, neck:{row:0,col:3},
  weapon:{row:1,col:0},                                          chest:{row:1,col:3},
  foot:{row:2,col:0},                                            back:{row:2,col:3},
  legs:{row:3,col:0}, waist:{row:3,col:1}, palm:{row:3,col:2}, wrist:{row:3,col:3},
};
...
function renderEquipCompassHtml(items){
  ...
  const hub = `<div class="equip-hub" style="grid-row:2 / span 2;grid-column:2 / span 2;"><div class="equip-hub-icon">🧍</div></div>`;
