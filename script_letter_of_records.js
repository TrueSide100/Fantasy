...
function defaultPanel(){
  return { numSeq:0, numMap:{}, photos:{}, equipHub:{ top:null, bottom:null }, categories: {
...
function migrateOldPanel(old){
  ...
  const panel = { numSeq:0, numMap:{}, photos:{}, equipHub:{ top:null, bottom:null }, categories: {
...
function sanitizePanel(p){
  ...
  const out = { categories:{}, numSeq: typeof p.numSeq==='number' ? p.numSeq : 0, numMap: (p.numMap && typeof p.numMap==='object') ? p.numMap : {}, photos: (p.photos && typeof p.photos==='object') ? p.photos : {}, equipHub: (p.equipHub && typeof p.equipHub==='object') ? { top: p.equipHub.top || null, bottom: p.equipHub.bottom || null } : { top:null, bottom:null } };
