...
// catch the latter.
//
// Only ever called once, for a brand-new world with no story yet (same !hadStory gate
// as seedSkillsFromLore at the call site in index.html) — never re-run on a later lore
// edit, so re-saving the same world can't duplicate or clobber a balance the story has
// since moved on from. Also refuses to write over a Finances category that already has
// ANY tracked currency, as a second, belt-and-braces check independent of that gate.
