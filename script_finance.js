/* script_finance.js — Finances: the deterministic currency guards that keep that
   ...
   This is one third of what used to be a single script_fieb.js (Finances/Inventory/
   Equip Box), itself one half of the original script_letter-of-records.js. Split again
   so this file can be read and edited independently of the item-tracking half
   (script_inventory_equip.js: Inventory + Equip Box). Depends on globals from
   index.html's inline Section 1 (load that file first); load order relative to
   script_chatroom.js, script_inventory_equip.js, script_tase.js, and script_saal.js
   ...
   Contains section 1 of the original script_fieb.js:
   ...
   Sections 2 (INVENTORY) and 3 (EQUIP BOX) now live in script_inventory_equip.js.
