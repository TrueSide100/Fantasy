/* ================================================================================
   ...
   Kept separate on purpose, and still required alongside this file:
     ...
     - script_tase.js / script_saal.js: Timeline, Scheduled Events, Skills &
       ...
       (guardSkillProgress, guardSkillGraduation, guardTimelineDay,
...
/* ################################################################################
   ...
   script_fieb.js and script_tsal.js, and uses index.html's inline storage/AI
   helpers (Section 1 of the original app shell).
################################################################################ */
...
// and the Inventory modal's open/close wiring now live in script_fieb.js
...
// and scheduled-events logic all live in script_fieb.js and script_tsal.js (see the MOVED
// banners in 2.3 below), including the claim-checking pipeline sendMessage() gates on.
// ================================================================================
